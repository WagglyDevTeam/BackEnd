...
import team.waggly.backend.repository.UserRespository

@Service
class SignupService(private val userRespository: UserRespository){
    fun userSignup(signupRequestDto: SignupDto.Request): SignupDto.Response {
        ...
        val encodedPassword = signupRequestDto.password
